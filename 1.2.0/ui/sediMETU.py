...
class MyApp(QtWidgets.QMainWindow):
    ...
    def calculateWave(self):
        ...
        self.ui.concentrationCrest_Wave_txt.setText('%.8f'%waveRes.suspendedTransportRate()["Crest"])
        self.ui.concentrationTrough_Wave_txt.setText('%.8f'%waveRes.suspendedTransportRate()["Trough"])
        self.ui.concentrationNet_Wave_txt.setText('%.8f'%waveRes.suspendedTransportRate()["Net"])
