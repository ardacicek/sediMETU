...
```
What's new in v1.2.0 Changelog (02.10.2021):
- Suspended transport rates under Stoke's 2nd order assumption using Eqns. 55a and 55b
(Waves Module),
- Suspension profiles under crest and trough (Waves Module).
```
